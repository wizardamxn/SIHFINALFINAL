  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        paddingLeft: visible ? 10 : 16,
        paddingRight: visible ? 10 : 16,
        paddingTop: visible ? 4 : 8,
        paddingBottom: visible ? 4 : 8,
        borderRadius: visible ? 20 : 32,
      }}
      transition={{
        type: "spring",
        stiffness: 360,
      ...
      style={{ maxWidth: visible ? 960 : 1280 }}
      className={cn(
